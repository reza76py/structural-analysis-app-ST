...
#     # ✅ Z-section filtering options (only applies to XY view)
#     z_section = None
#     filter_mode = None
...
#         if enable_filter:
#             z_section = st.sidebar.number_input("Z value to filter by", value=0)
...
#             nodes, elements,
#             z_section=z_section if filter_mode else None,
